...
import DeafualtInfo from './Component/DefaultData';


function App() {

  const [info, setInfo] = useState(DeafualtInfo);
        ...
        <div className="container w-100">
          ...
          <div className="info-section w-100 mx-auto">
            {info.map((c,index) => {
              ...
              return (
                <div className='row row-cols-lg-4 row-cols-md-2 row-cols-1 bg-white rounded-3 mx-auto shadow ' key={index}>
                  ...
                  <div className="col px-lg-1 py-lg-4 px-3 py-3 d-flex justify-content-lg-between justify-content-center">
                    <div className='info-text text-lg-start text-center'>
                      <h6>LOCATION</h6>
                      <h2 className='text-break'>{`${region},${country},${city}`}</h2>
                    </div>
                    <div className="vr"></div>
                  </div>
